...
export default {
	...
	BET_MODE_ANTE_DIALOG:
		'Verdoppelt die Bonus-Trigger-Rate und erhoeht die Eye-Frequenz fuer 1.25x Einsatz. ANTE BET bleibt aktiv, bis es deaktiviert wird.',
	...
	BET_MODE_SUPERSPINS_DIALOG:
		'Ein einzelner Spin fuer 20x Einsatz mit garantiertem Eye - weitere koennen mitten im Tumble hereinfallen. Kein Schneeball - ein knackiger Aufbau und Abschluss.',
	...
	BET_MODE_BONUS_DIALOG:
		'Loest Free Spins fuer 100x Einsatz aus - die Trigger-Scatter zahlen ihr Sofortgeld zusaetzlich. Der persistente Multiplikator (M) waechst ueber das Feature, wenn Eyes landen.',
	...
	BET_MODE_ULTIMATE_DIALOG:
		'Immer mindestens 2 Eyes auf dem Feld (2-5, weitere koennen hereinfallen) fuer 300x Einsatz - ihre ADD- und MUL-Werte kombinieren sich in einer Aufloesung.',
	...
	BET_MODE_SUPERBONUS_DIALOG:
		'Kauft das Free-Spins-Feature fuer 500x Einsatz. Der Gaze laedt mit doppelter Essence (+4/+6/+10 pro Cluster) und die Trigger-Scatter zahlen ihr Sofortgeld. Der Modus, der dem 15.000x-Cap am oeftesten nahekommt.',
	...
	GAME_INFO_SPECIAL_SCATTER_DESCRIPTION_HTML:
		'<strong>4+</strong> loest Free Spins aus und zahlt sofort: <strong>4 = 3x</strong>, <strong>5 = 5x</strong>, <strong>6 = 100x</strong> &ndash; auch bei gekauften Features.',
	...
	GAME_INFO_MODE_SUPER_BONUS_TEXT:
		'Free Spins mit doppelter Essence-Ladung und hart zuschlagenden MULTIPLY Eyes.',
