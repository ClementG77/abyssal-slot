...
export default {
	...
	LOADER_CARD_1_BODY: 'Cluster menang mengisi Gaze Anda.\nLebih banyak Tumbles membangun lebih banyak kekuatan.',
	...
	ON: 'NYALA',
	OFF: 'MATI',
	ANTE_SWITCH_NOTE: 'Lebih banyak Eyes & Scatters - taruhan 1.25x',
	AUTO: 'AUTO',
	ALL: 'SEMUA',
	START: 'MULAI',
	BET_MODE_BASE_TITLE: 'DASAR',
	BET_MODE_BASE_DIALOG: 'Spin Abyssal standar. Eye jarang muncul dan kebanyakan bertipe ADD.',
	...
	BET_MODE_ANTE_DIALOG:
		'Meningkatkan frekuensi Eye dan Scatter dengan taruhan 1.25x. ANTE BET tetap aktif sampai dinonaktifkan.',
	...
	BET_MODE_SUPERSPINS_DIALOG:
		'Satu spin seharga taruhan 20x dengan Eye dijamin muncul. Tanpa snowball - satu bangunan kuat dan pelepasan.',
	...
	BET_MODE_BONUS_DIALOG:
		'Memicu Free Spins seharga taruhan 100x. Pengali persisten (M) terus membesar selama fitur saat Eye muncul.',
	...
	BET_MODE_ULTIMATE_DESCRIPTION: 'Final multi-Eye - beberapa Eyes diselesaikan sekaligus.',
	BET_MODE_ULTIMATE_DIALOG:
		'Satu-satunya mode di mana beberapa Eyes terbuka bersama seharga taruhan 300x, menggabungkan nilai ADD dan MUL dalam satu penyelesaian.',
	...
	BET_MODE_SUPERBONUS_DESCRIPTION: 'Mode ekor - charge +2 dan MUL sering muncul.',
	BET_MODE_SUPERBONUS_DIALOG:
		'Membeli fitur Free Spins seharga taruhan 500x dengan charge Gaze +2 per koneksi dan MUL Eyes sering muncul. Mode yang paling sering mendekati batas 15,000x.',
	...
	GAME_INFO_SPECIAL_SCATTER_DESCRIPTION_HTML:
		'<strong>4+</strong> memicu Free Spins dan membayar langsung: <strong>4 = 3x</strong>, <strong>5 = 5x</strong>, <strong>6 = 100x</strong>.',
	...
	GAME_INFO_EYE_GAZE_DESCRIPTION_HTML:
		'Setiap tumble menang mengisi <strong>Gaze</strong> sebesar 1. Jika <strong>Eye</strong> ada di papan pada akhir spin menang, Eye mengubah Gaze menjadi satu pengali besar yang diterapkan ke semua kemenangan pada spin tersebut.',
	GAME_INFO_EYE_GAZE_EXAMPLE_HTML:
		'Contoh: kemenangan 2x dengan Gaze 3 dan ADD Eye mulai dari 10 &rarr; x13 &rarr; membayar 26x. MULTIPLY Eye &rarr; x30 &rarr; membayar 60x.',
	...
	GAME_INFO_MODE_BASE_TEXT: 'Game standar. Eye jarang muncul, kebanyakan tipe ADD yang ramah.',
	GAME_INFO_MODE_ANTE_COST: 'taruhan 1.25x',
	GAME_INFO_MODE_ANTE_TEXT: 'Bayar 25% lebih untuk Eyes dan Scatters yang lebih sering.',
	GAME_INFO_MODE_BUY_FREE_SPINS_NAME: 'Beli Free Spins',
	GAME_INFO_MODE_BUY_FREE_SPINS_COST: 'taruhan 100x',
	GAME_INFO_MODE_BUY_FREE_SPINS_TEXT: 'Beli langsung ke fitur Free Spins.',
	...
	GAME_INFO_MODE_SUPER_BONUS_TEXT:
		'Free Spins dengan Gaze mengisi dua kali lebih cepat dan MULTIPLY Eyes sering muncul.',
	GAME_INFO_MODE_ULTIMATE_NAME: 'Ultimate',
	GAME_INFO_MODE_ULTIMATE_COST: 'taruhan 300x',
	GAME_INFO_MODE_ULTIMATE_TEXT:
		'Satu spin dengan beberapa Eyes sekaligus yang bergabung - sangat besar atau tidak sama sekali.',
