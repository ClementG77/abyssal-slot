...
export default {
	...
	BET_MODE_ANTE_DIALOG:
		'يضاعف معدل تفعيل البونص ويزيد وتيرة ظهور Eye مقابل 1.25x من الرهان. يبقى ANTE BET نشطا حتى يتم إيقافه.',
	...
	BET_MODE_SUPERSPINS_DIALOG:
		'دورة واحدة مقابل 20x من الرهان مع ضمان ظهور Eye - وقد يسقط المزيد في منتصف Tumble. لا كرة ثلجية - شحن واحد قوي وإطلاق واحد.',
	...
	BET_MODE_BONUS_DIALOG:
		'يفعل Free Spins مقابل 100x من الرهان - كما تدفع رموز Scatter المفعلة جائزتها الفورية. يتراكم المضاعف المستمر (M) خلال الميزة كلما ظهر Eye.',
	...
	BET_MODE_ULTIMATE_DIALOG:
		'دائما ما لا يقل عن 2 Eyes على اللوحة (2-5، وقد يسقط المزيد) مقابل 300x من الرهان، لتجمع قيم ADD و MUL في حل واحد.',
	...
	BET_MODE_SUPERBONUS_DIALOG:
		'يشتري ميزة Free Spins مقابل 500x من الرهان. يشحن Gaze بمقدار Essence مضاعف (+4/+6/+10 لكل مجموعة) وتدفع رموز Scatter المفعلة جائزتها الفورية. الوضع الأقرب غالبا إلى حد 15,000x.',
	...
	GAME_INFO_SPECIAL_SCATTER_DESCRIPTION_HTML:
		'<strong>4+</strong> يفعل Free Spins ويدفع فورا: <strong>4 = 3x</strong>، <strong>5 = 5x</strong>، <strong>6 = 100x</strong> &ndash; وكذلك في الميزات المشتراة.',
	...
	GAME_INFO_MODE_SUPER_BONUS_TEXT:
		'Free Spins حيث يشحن Gaze بمقدار Essence مضاعف وتضرب MULTIPLY Eyes بقوة.',
