export default {
	...
	BET_MODE_ANTE_DIALOG:
		'Increases the Eye and Scatter frequency for 1.25x the bet. ANTE BET stays active until disabled.',
	...
	BET_MODE_SUPERSPINS_DIALOG:
		'A single spin for 20x the bet with the Eye guaranteed to land. No snowball - one punchy build and release.',
	...
	BET_MODE_BONUS_DIALOG:
		'Triggers Free Spins for 100x the bet. The persistent multiplier (M) snowballs across the feature as the Eye lands.',
	...
	BET_MODE_ULTIMATE_DIALOG:
		'The only mode where multiple Eyes open together for 300x the bet, combining their ADD and MUL values in one resolution.',
	...
	BET_MODE_SUPERBONUS_DIALOG:
		'Buys the Free Spins feature for 500x the bet with +2 Gaze charge per connection and MUL Eyes common. The mode that most often approaches the 15,000x cap.',
