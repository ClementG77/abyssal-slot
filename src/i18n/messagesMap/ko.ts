...
export default {
	...
	ON: '켜짐',
	OFF: '꺼짐',
	ANTE_SWITCH_NOTE: 'Eyes 및 Scatters 증가 - 1.25x 베팅',
	AUTO: '자동',
	ALL: '전체',
	START: '시작',
	BET_MODE_BASE_TITLE: '기본',
	BET_MODE_BASE_DIALOG: '표준 Abyssal 스핀입니다. Eye는 드물고 대부분 ADD입니다.',
	...
	BET_MODE_ANTE_DIALOG:
		'베팅의 1.25x로 Eye 및 Scatter 빈도를 높입니다. ANTE BET는 비활성화할 때까지 유지됩니다.',
	...
	BET_MODE_SUPERSPINS_DIALOG:
		'베팅의 20x로 Eye가 반드시 등장하는 단일 스핀입니다. 스노우볼은 없고, 강력한 한 번의 축적과 해방입니다.',
	...
	BET_MODE_BONUS_DIALOG:
		'베팅의 100x로 Free Spins를 발동합니다. 지속 배수(M)는 Eye가 등장할 때마다 기능 중 계속 커집니다.',
	...
	BET_MODE_ULTIMATE_DESCRIPTION: '멀티 Eye 피날레 - 여러 Eyes가 한 번에 처리됩니다.',
	BET_MODE_ULTIMATE_DIALOG:
		'여러 Eyes가 베팅의 300x로 함께 열리고 ADD 및 MUL 값을 하나로 결합하는 유일한 모드입니다.',
	...
	BET_MODE_SUPERBONUS_DESCRIPTION: '테일 모드 - +2 충전 및 잦은 MUL.',
	BET_MODE_SUPERBONUS_DIALOG:
		'베팅의 500x로 Free Spins 기능을 구매하며, 연결마다 Gaze 충전 +2와 잦은 MUL Eyes가 적용됩니다. 15,000x 한도에 가장 자주 가까워지는 모드입니다.',
	...
	GAME_INFO_SPECIAL_SCATTER_DESCRIPTION_HTML:
		'<strong>4+</strong>가 Free Spins를 발동하고 즉시 지급합니다: <strong>4 = 3x</strong>, <strong>5 = 5x</strong>, <strong>6 = 100x</strong>.',
	...
	GAME_INFO_EYE_GAZE_DESCRIPTION_HTML:
		'승리 tumble마다 <strong>Gaze</strong>가 1 충전됩니다. 승리 스핀 끝에 <strong>Eye</strong>가 보드에 있으면, Gaze를 해당 스핀에서 얻은 모든 승리에 적용되는 큰 배수로 바꿉니다.',
	GAME_INFO_EYE_GAZE_EXAMPLE_HTML:
		'예: Gaze 3, 시작값 10의 ADD Eye와 2x 승리 &rarr; x13 &rarr; 26x 지급. MULTIPLY Eye &rarr; x30 &rarr; 60x 지급.',
	...
	GAME_INFO_MODE_BASE_TEXT: '표준 게임입니다. Eye는 드물고 대부분 친숙한 ADD 타입입니다.',
	GAME_INFO_MODE_ANTE_COST: '1.25x 베팅',
	GAME_INFO_MODE_ANTE_TEXT: '25% 더 지불하고 Eyes와 Scatters를 더 자주 얻습니다.',
	GAME_INFO_MODE_BUY_FREE_SPINS_NAME: 'Free Spins 구매',
	GAME_INFO_MODE_BUY_FREE_SPINS_COST: '100x 베팅',
	GAME_INFO_MODE_BUY_FREE_SPINS_TEXT: 'Free Spins 기능으로 바로 구매합니다.',
