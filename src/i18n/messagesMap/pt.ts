...
export default {
	...
	ON: 'ON',
	OFF: 'OFF',
	ANTE_SWITCH_NOTE: 'Mais Eyes e Scatters - aposta 1.25x',
	AUTO: 'AUTO',
	ALL: 'TODOS',
	START: 'INICIAR',
	BET_MODE_BASE_TITLE: 'BASE',
	BET_MODE_BASE_DIALOG: 'O giro Abyssal padrao. O Eye e raro e geralmente do tipo ADD.',
	...
	BET_MODE_ANTE_DIALOG:
		'Aumenta a frequencia de Eyes e Scatters por 1.25x a aposta. ANTE BET fica ativo ate ser desativado.',
	...
	BET_MODE_SUPERSPINS_DIALOG:
		'Um unico giro por 20x a aposta com Eye garantido. Sem snowball - uma carga forte e liberacao.',
	...
	BET_MODE_BONUS_DIALOG:
		'Aciona Giros Gratis por 100x a aposta. O multiplicador persistente (M) cresce durante o recurso quando Eyes caem.',
	...
	BET_MODE_ULTIMATE_DESCRIPTION: 'O final multi-Eye - varios Eyes resolvem de uma vez.',
	BET_MODE_ULTIMATE_DIALOG:
		'O unico modo em que varios Eyes abrem juntos por 300x a aposta, combinando valores ADD e MUL em uma unica resolucao.',
	...
	BET_MODE_SUPERBONUS_DESCRIPTION: 'O modo final - carga +2 e MUL comum.',
	BET_MODE_SUPERBONUS_DIALOG:
		'Compra o recurso de Giros Gratis por 500x a aposta, com +2 de carga Gaze por conexao e Eyes MUL comuns. O modo que mais se aproxima do limite de 15,000x.',
	...
	GAME_INFO_SPECIAL_SCATTER_DESCRIPTION_HTML:
		'<strong>4+</strong> ativam Giros Gratis e pagam instantaneamente: <strong>4 = 3x</strong>, <strong>5 = 5x</strong>, <strong>6 = 100x</strong>.',
	...
	GAME_INFO_EYE_GAZE_DESCRIPTION_HTML:
		'Cada tumble vencedor carrega o <strong>Gaze</strong> em 1. Se um <strong>Eye</strong> estiver no tabuleiro ao fim de um giro vencedor, ele transforma o Gaze em um grande multiplicador aplicado a tudo que voce ganhou nesse giro.',
	GAME_INFO_EYE_GAZE_EXAMPLE_HTML:
		'Exemplo: ganho de 2x com Gaze 3 e Eye ADD com inicio 10 &rarr; x13 &rarr; paga 26x. Um Eye MULTIPLY &rarr; x30 &rarr; paga 60x.',
	...
	GAME_INFO_MODE_BASE_TEXT: 'O jogo padrao. O Eye e raro, geralmente o tipo ADD amigavel.',
	GAME_INFO_MODE_ANTE_COST: 'aposta 1.25x',
	GAME_INFO_MODE_ANTE_TEXT: 'Pague 25% a mais por Eyes e Scatters mais frequentes.',
	GAME_INFO_MODE_BUY_FREE_SPINS_NAME: 'Comprar Giros Gratis',
	GAME_INFO_MODE_BUY_FREE_SPINS_COST: 'aposta 100x',
	GAME_INFO_MODE_BUY_FREE_SPINS_TEXT: 'Compre direto para o recurso de Giros Gratis.',
	...
	GAME_INFO_MODE_SUPER_BONUS_TEXT:
		'Giros Gratis com Gaze carregando duas vezes mais rapido e Eyes MULTIPLY comuns.',
	GAME_INFO_MODE_ULTIMATE_NAME: 'Ultimate',
	GAME_INFO_MODE_ULTIMATE_COST: 'aposta 300x',
	GAME_INFO_MODE_ULTIMATE_TEXT:
		'Um giro com varios Eyes ao mesmo tempo que se combinam - enorme ou nada.',
