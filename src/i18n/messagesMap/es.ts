...
export default {
	...
	LOADER_CARD_1_BODY: 'Los grupos ganadores cargan tu Gaze.\nMas tumbles crean mas poder.',
	...
	ON: 'ON',
	OFF: 'OFF',
	ANTE_SWITCH_NOTE: 'Mas Eyes y Scatters - apuesta 1.25x',
	AUTO: 'AUTO',
	ALL: 'TODO',
	START: 'INICIAR',
	BET_MODE_BASE_TITLE: 'BASE',
	BET_MODE_BASE_DIALOG: 'El giro Abyssal estandar. El Eye es raro y casi siempre de tipo ADD.',
	...
	BET_MODE_ANTE_DIALOG:
		'Aumenta la frecuencia de Eyes y Scatters por 1.25x la apuesta. ANTE BET permanece activo hasta desactivarlo.',
	...
	BET_MODE_SUPERSPINS_DIALOG:
		'Un solo giro por 20x la apuesta con un Eye garantizado. Sin snowball: una carga potente y liberacion.',
	...
	BET_MODE_BONUS_DIALOG:
		'Activa Giros Gratis por 100x la apuesta. El multiplicador persistente (M) crece durante la funcion cuando caen Eyes.',
	...
	BET_MODE_ULTIMATE_DESCRIPTION: 'El final multi-Eye: varios Eyes se resuelven a la vez.',
	BET_MODE_ULTIMATE_DIALOG:
		'El unico modo donde varios Eyes se abren juntos por 300x la apuesta, combinando sus valores ADD y MUL en una sola resolucion.',
	...
	BET_MODE_SUPERBONUS_DESCRIPTION: 'El modo final: carga +2 y MUL frecuente.',
	BET_MODE_SUPERBONUS_DIALOG:
		'Compra la funcion de Giros Gratis por 500x la apuesta, con +2 de carga Gaze por conexion y Eyes MUL frecuentes. El modo que mas suele acercarse al limite de 15,000x.',
	...
	GAME_INFO_SPECIAL_SCATTER_DESCRIPTION_HTML:
		'<strong>4+</strong> activan Giros Gratis y pagan al instante: <strong>4 = 3x</strong>, <strong>5 = 5x</strong>, <strong>6 = 100x</strong>.',
	...
	GAME_INFO_EYE_GAZE_DESCRIPTION_HTML:
		'Cada tumble ganador carga la <strong>Gaze</strong> en 1. Si hay un <strong>Eye</strong> en el tablero al final de un giro ganador, convierte la Gaze en un gran multiplicador aplicado a todo lo ganado en ese giro.',
	GAME_INFO_EYE_GAZE_EXAMPLE_HTML:
		'Ejemplo: una ganancia de 2x con Gaze de 3 y un Eye ADD que empieza en 10 &rarr; x13 &rarr; paga 26x. Un Eye MULTIPLY &rarr; x30 &rarr; paga 60x.',
	...
	GAME_INFO_MODE_BASE_TEXT: 'El juego estandar. El Eye es raro, casi siempre el tipo ADD amable.',
	GAME_INFO_MODE_ANTE_COST: 'apuesta 1.25x',
	GAME_INFO_MODE_ANTE_TEXT: 'Paga 25% mas por Eyes y Scatters mas frecuentes.',
	GAME_INFO_MODE_BUY_FREE_SPINS_NAME: 'Comprar Giros Gratis',
	GAME_INFO_MODE_BUY_FREE_SPINS_COST: 'apuesta 100x',
	GAME_INFO_MODE_BUY_FREE_SPINS_TEXT: 'Compra acceso directo a la funcion de Giros Gratis.',
	...
	GAME_INFO_MODE_SUPER_BONUS_TEXT:
		'Giros Gratis con la Gaze cargando el doble de rapido y Eyes MULTIPLY frecuentes.',
	GAME_INFO_MODE_ULTIMATE_NAME: 'Ultimate',
	GAME_INFO_MODE_ULTIMATE_COST: 'apuesta 300x',
	GAME_INFO_MODE_ULTIMATE_TEXT:
		'Un giro con varios Eyes a la vez que se combinan: enorme o nada.',
