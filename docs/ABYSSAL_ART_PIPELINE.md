...
1. **Coherence > fidelity.** A set of 30 assets that share _one_ believable style looks
...
- **Render:** painterly semi-realistic, soft focus at depth, fine particulate (marine snow),
  subtle chromatic depth haze. Cinematic, ominous, awe — _not_ cute, _not_ photoreal.
...
- **Perfect set cohesion** takes iteration + cleanup — the hidden cost is _making 30 assets
  look like one game_, not generating them.
...
- Net: the static-art + code-juice + audio hybrid reaches **very polished and atmospheric**
  (~80–90% of the _feel_). The last 10–20% (a Pragmatic art team) is the part AI won't close.
